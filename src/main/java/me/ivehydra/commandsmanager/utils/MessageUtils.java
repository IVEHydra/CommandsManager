...
public enum MessageUtils {
    ...
    NO_PLAYER("messages.command.reset.noPlayer"),
    NO_COOLDOWN("messages.command.reset.noCooldown"),
    COOLDOWN_REMOVED("messages.command.reset.cooldownRemoved"),
    ALL_COOLDOWNS_REMOVED("messages.command.reset.allCooldownsRemoved"),
